...
- `device`：设备/组件标识（如磁盘、网卡等，可选）— 用于钉钉告警通知中补充机器信息

## 字段示例

**链路追踪日志示例**（必须同时包含 task_id 和 trace_id）：
```json
{"ts":"2026-02-12T12:34:56.789Z","level":"info","service":"draw-gateway","task_id":"task_abc123","trace_id":"0123456789abcdef0123456789abcdef","span_id":"89abcdef01234567","request_id":"req_456","event":"task.started","msg":"任务开始处理","instance":"192.168.1.10:8000","device":""}
```

**普通运行日志示例**（不包含链路追踪字段）：
```json
{"ts":"2026-02-12T12:34:56.789Z","level":"info","service":"draw-gateway","instance":"192.168.1.10:8000","device":"","event":"app.startup","msg":"应用启动完成"}
```
